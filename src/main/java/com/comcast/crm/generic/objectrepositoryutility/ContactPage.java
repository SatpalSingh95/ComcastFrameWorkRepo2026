...
public class ContactPage {
	...
	/*
	 * public WebElement getSupportStartDate() { return supportStartDate; }
	 * 
	 * public WebElement getSupportEndDate() { return supportEndDate; }
	 */
	public String getSupportStartDate() {
	    return supportStartDate.getAttribute("value");
	}

	public String getSupportEndDate() {
	    return supportEndDate.getAttribute("value");
	}
